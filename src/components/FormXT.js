            ...
            <div className="" style={{backgroundImage: `url(${bgVT})`, backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "cover"}}>
                <div className="bg-[#214287]/80">
                    <div className="py-20 container mx-auto">
                        ...
                        <form className="grid grid-cols-2 gap-x-5 lg:gap-x-10 gap-y-5 mx-2 lg:mx-40 pb-6">
                            <input id="" className="rounded-md h-14 px-5" type="" placeholder="Họ và tên *" />
                            <input id="" className="rounded-md h-14 px-5" type="date" placeholder="Ngày sinh (dd/mm/yyyy) *" />
                            <input id="" className="rounded-md h-14 px-5" type="" placeholder="Số điện thoại *" />
                            <input id="" className="rounded-md h-14 px-5" type="" placeholder="Email *" />
                            <input id="" className="rounded-md h-14 px-5" type="" placeholder="Bạn đang sống ở đâu *" />
                            <select className="rounded-md h-14 px-5" defaultValue={""} name="nganhXT" id="nganhXT">
                                <option value="" disabled hidden>Chọn ngành xét tuyển *</option>
                    ...
                    <div className="grid grid-cols-3 lg:grid-cols-6 gap-6 justify-items-center container px-2 mx-auto pb-24">
                        <div className="bg-white w-full max-h-max">
                            <a href=" " className="flex justify-center items-center">
                                <img src={HHLogo} alt="" className="max-lg:h-full lg:h-40" />
                            </a>
                        </div>
                        <div className="bg-white w-full max-h-max">
                            <a href=" " className="flex justify-center items-center">
                                <img src={VHULogo} alt="" className="max-lg:h-full lg:h-40" />
                            </a>
                        </div>
                        <div className="bg-white w-full max-h-max">
                            <a href=" " className="flex justify-center items-center">
                                <img src={HHELogo} alt="" className="max-lg:h-full lg:h-40" />
                            </a>
                        </div>
                        <div className="bg-white w-full max-h-max">
                            <a href=" " className="flex justify-center items-center">
                                <img src={ALCLogo} alt="" className="max-lg:h-full lg:h-40" />
                            </a>
                        </div>
                        <div className="bg-white w-full max-h-max">
                            <a href=" " className="flex justify-center items-center">
                                <img src={VHLogo} alt="" className="max-lg:h-full lg:h-40" />
                            </a>
                        </div>
                        <div className="bg-white w-full max-h-max">
                            <a href=" " className="flex justify-center items-center">
                                <img src={BMSGLogo} alt="" className="max-lg:h-full lg:h-40" />
                            </a>
                        </div>
                    </div>
                </div>
